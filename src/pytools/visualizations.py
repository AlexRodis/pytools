# Model visualization tools module. Contains tools for visualizing
# models and data. The following tools are defined here:
# - | ResponseSurfaceVisualizer := Plot multidimensional models as a 
#     surface. Each surface plots two features against a scalar output.
#     For multivariate outputs, multiple surfaces can be plotted for
#     multiple outputs
# - | ContourSurfaceVisualizer := Plot contours for multivariate models.
# - | categorical_scatter := Create tri variate scatterplots of two 
#     continuous variables against a third categorical variable (hue).
#     Is a subplot Generator object allowing for plotting of subsets of
#     data
# - |  boxplots := Generator implementation of 
#      `pandas.DataFrame.boxplot` for boxplotting highly dimensional 
#       datasets
# - |  advi_inspect_ELBO := Plot Evidence Lower Bound (ELBO) progression
#      against inference, for model criticism. Will eventually be deprecated
#      by a pymc implementation 
